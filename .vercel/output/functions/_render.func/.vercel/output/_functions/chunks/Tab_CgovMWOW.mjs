...
import { h as humanize } from './_astro_content_CY9UuciB.mjs';
...
const Button = ({
  ...
  return /* @__PURE__ */ jsx(
    "a",
    {
      ...
      className: `btn mb-4 me-4 dark:hover:text-black hover:no-underline ${style === "outline" ? "btn-outline-primary" : "btn-primary"}`,
      children: label
    }
  );
};
...
export { Accordion as A, Button as B, Notice as N, Tabs as T, Video as V, Youtube as Y, Tab as a };
